...
1. SALT3 model realizations training (see instructions in SALT3_training.md attached)
2. Full analysis pipeline via Pippin (see guidelines in pippin_pipeline.md attached) 
